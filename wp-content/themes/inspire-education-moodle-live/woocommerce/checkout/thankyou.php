...
if ( $order ) : ?>
	...
	<?php else : ?>
		...
		<ul class="order_details">
			...
			<p><?php if ( $order->get_payment_method_title() ) : ?>
			<li class="method">
		...
		<p>
		<p style="font-size:22px; font-weight:500; color:#4680b6; margin-bottom:8px;"><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', __( 'Congratulations on taking the first step, and "sparking" your learning journey!</p><br>
		<p style="font-size:18px;"><strong>IMPORTANT:</strong> - Your enrolment cannot be processed until we confirm payment has been made.  To avoid losing any discount or special pricing, you <strong>must pay immediately.</strong><p>
		(NOTE:  If you have already paid through PayPal or credit card, no further action is required)
	<p>  Once paid, you will receive your course logins within 5 business days (usually less).  A confirmation email from Inspire Education <<a href="mailto:onlineenrolments@inspireeducation.net.au">onlineenrolments@inspireeducation.net.au</a>> has been sent to the email address below.<br/><br/>If you have not received an email within 10 to 15 minutes, please check your spam/junk folder.</p?
		<p><b>*** NOTE:  If you have already paid through PayPal or credit card, no further action is required ***</b> ', 'woocommerce' ), $order ); ?></p>
		<p style="font-size:22px; font-weight:500; color:#4680b6; margin-bottom:8px;">We can't wait to help you "Find Your Spark!"</p><br>
