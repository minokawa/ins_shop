...
class QueryGenerator {
	...
	public static function checkTable($table_name, $type) {
		...
		$table = "inspire_".$table_name."_hour_".$type;
	...
	public static function createDayTable($table_name, $type) {
		$command = 'CREATE TABLE if not exists ' . 'inspire_'.$table_name.'_day_'.$type;
	...
	public static function createHourTable($table_name, $type) {
		$command = 'CREATE TABLE if not exists ' . 'inspire_'.$table_name.'_hour_'.$type;
	...
	public static function createMinuteTable($table_name, $type) {
		$command = 'CREATE TABLE if not exists ' . 'inspire_'.$table_name.'_minute_'.$type;
